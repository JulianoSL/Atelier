...
<body class="text-center">
    ...
    <main class="form-signin">
        <form action="" method="post">
            ...
            <a href="signIn.php">Pas encore inscrit ? Créer un compte</a>
            <button class="w-100 btn btn-lg btn-primary" type="submit" name="Connexion" value="Connexion">Se connecter</button>
            <p><?= $erreur ?></p>
